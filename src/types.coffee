...
@declare 'mixa_jobdef', tests:
  ...
  "x.?default_command is a nonempty_text":  ( x ) -> @isa_optional.nonempty_text  x.default_command
  "x has only keys 'meta', 'commands', 'exit_on_error', 'default_command'": ( x ) ->
    has_only_keys x, [ 'meta', 'commands', 'exit_on_error', 'default_command', ]
