(function() {
  'use strict';
  var CND, SEMVER, alert, badge, debug, echo, help, info, packages_and_versions, rpr, urge, warn, whisper;
  ...
  (() => {    //===========================================================================================================
    var matcher, offenders, package_name, ref, version;
    offenders = [];
    ref = packages_and_versions.pinned_versions;
...
//# sourceMappingURL=pinned-package-version-checker.js.map