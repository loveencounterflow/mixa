(function() {
  ...
  this.declare('mixa_cmddef', {
    tests: {
      ...
      "x.?run is a _mixa_runnable": function(x) {
        return this.isa_optional._mixa_runnable(x.run);
      },
      "x has only keys 'description', 'allow_extra', 'flags', 'run'": function(x) {
        return has_only_keys(x, ['description', 'allow_extra', 'flags', 'run']);
      }
    }
  });
